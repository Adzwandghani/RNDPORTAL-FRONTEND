                        ...
                        <div class="card-body">
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        <form>
                                            <p class="title" style="text-align: center;">WELCOME TO RNDPORTAL </p>
                                            <p style="text-align: center;">MUHHAMAD ADZWAN BIN MOHAMAD GHANI</p>

                                            

                                            <div class="d-grid gap-2 justify-content-center">
                                                <button type="submit" class="btn" id="logintextbuttonuser"><a id="logintextbuttonuser" href="{{ route('myprofile') }}">MY PROFILE</a></button>
                                            </div>

                                            <br>

                                            <div class="d-grid gap-2 justify-content-center">
                                                <button type="submit" class="btn" id="logintextbuttonuser"><a id="logintextbuttonuser" href="{{ route('administrator') }}">ADMINISTRATOR</a></button>
                                            </div>

                                            <br>
                                            <div class="d-grid gap-2 justify-content-center">
                                                <button type="submit" class="btn" id="logintextbuttonuser"><a id="logintextbuttonuser" href="{{ route('home') }}">LOG OUT</a></button>
                                            </div>
